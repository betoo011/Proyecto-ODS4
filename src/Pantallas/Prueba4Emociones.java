 ...
 * @author pc
 */
public class Prueba4Emociones extends javax.swing.JFrame {

    /**
     * Creates new form Prueba4Emociones
     */
    public Prueba4Emociones() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/tristeza(emocion).png"))); // NOI18N
...
private void OcultarMensaje(JLabel label, int milisegundos) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prueba4Emociones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Prueba4Emociones().setVisible(true);
            }
        });
    }
